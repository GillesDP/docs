...
## Content Editor
When clicking on any of the currently active fragments, you are prompted with configuration options. These options may be different for different fragment types. For example, a banner fragment will have a title, description, and button text, while a FAQ fragment will have a configurable list of questions and answers.
<Frame>
